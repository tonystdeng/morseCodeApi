...
@app.route("/")
def index():
    return "<h1>An API that translates morse code!</h1>"
...
def m2cAlpha():
    alpha={}
    for key in m2cDict.keys():
        if key.isalpha():
            alpha[key]=m2cDict[key]
